...
const CategorySelection = ({ onSelectCategory, activeCategory }) => {
    ...
    // Define tus categorías aquí, o consúltalas desde una API
    const categories = [];

    return (
        <div className="px-4 mb-8 lg:space-x-16 gap-12 flex flex-wrap items-center border-b-2 py-5 text-gray-900 font-semibold">
                {/* <button onClick={() => onSelectCategory(null)} className={`lg:ml-12 ${activeCategory ? '' : 'active-button'}`}>Todos</button> */}            
